...
Additionally, rather than re-programming the display character, there is also a function available to [remap the character to a bitmap](https://github.com/sijnstra/agon-docs/blob/main/docs/vdp/System-Commands.md#vdu-23-0-92-char-bitmapid-map-character-char-to-display-bitmapid-), allowing these font character replacements to be multi-coloured.
